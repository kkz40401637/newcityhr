...
let tank = $('.water-tank').analogTank(options);

$(".water-tank").resizable({
...
function shrink() {
    document.getElementsByClassName('water-tank')[0].setAttribute("style", "width:200px;height:200px;");
    tank.redraw();
}
function enlarge() {
    document.getElementsByClassName('water-tank')[0].setAttribute("style", "width:400px;height:400px;");
    tank.redraw();
}
function high() {
