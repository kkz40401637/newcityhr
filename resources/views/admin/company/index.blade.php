        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('AddCompany')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW COMPANY + </a>&nbsp;&nbsp;&nbsp;
                    <h3 class="d-inline float-right" >COMPANY lIST</h3>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-4">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><div class="th-content">WEBSITE</div></th>
                                    ...
                                    @foreach ($CompanyDb as $key => $Company)
                                        <tr class="tr-{{$Company->id}}">
                                            <td><div class="td-content ">{{++$key}}</div></td>
                                            <td><div class="tc-content"></div><img style="border-radius: 50%;" width="70px" height="70px;" src="{{empty($Company->Profile)?asset('admin-assets/img/company/original').'/company-icon.png':asset('admin-assets/img/company').'/'.$Company->Profile}}"></td>
                                            <td>
                                            ...
                                            <td><div class="td-content text-dark">{{$Company->Phone}}</div></td>
                                            <td><div class="td-content text-dark">{{$Company->Email}}</div></td>
                                            <td><div class="td-content text-dark">{{$Company->Website}}</div></td>
                                            <td>
                                                <a class="btn btn-primary position-relative " href="{{route('EditCompanyInfo',$Company->Token)}}">
                                                    <i class="material-icons ">edit</i>
                                                </a>
                                            </td>
                                            <td>
                                                <button onclick="StationBanded({{$Company->id}})" class="station-ban-btn{{$Company->id}}  text-white btn bg-solid-red position-relative  ">
