        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('RequestJob')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW JOB POST + </a>&nbsp;&nbsp;&nbsp;
                                ...
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    @foreach ($JobDb as $key => $Job)
                                        <tr class="tr-{{$Job->id}}">
                                            ...
                                            <td>
                                                <a href="{{route('EditJobPostForm',$Job->Token)}}" class="btn bg-primary position-relative ">
