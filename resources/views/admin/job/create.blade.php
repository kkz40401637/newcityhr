                ...
                <div class="col-sm-12 col-md-7 layout-spacing">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission " data-form-permission="0">
                            <form action="{{route('RequestJob')}}" class="form-sample" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    @if (session('success'))
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" value="NodeJS Senior Developer" class="form-control Title" name="Title" placeholder="TITLE" aria-label="notification" aria-describedby="basic-addon1">
                                    </div>
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" value="Senior Fullstack Developer ( 5 Yr Experience )" class="form-control Position" name="Position" placeholder="POSITION" aria-label="notification" aria-describedby="basic-addon1">
                                    </div>
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" value="Mingala Done Town Ship" class="form-control Location" name="Location" placeholder="LOCATION" aria-label="notification" aria-describedby="basic-addon1">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="input-group my-3">
                                                ...
                                                <input type="text" value="$800" class="form-control RangeFrom" name="RangeFrom" placeholder="SALART RANGE ( FROM )">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="input-group my-3">
                                                ...
                                                <input type="text" value="$1000" class="form-control RangeFrom" name="RangeTo" placeholder="SALART RANGE ( TO )">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <input name="DueDate" id="DueDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Due Date">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="input-group my-3">
                                                ...
                                                <input type="text" value="( 5 Yr Experience )" class="form-control Experience" name="Experience" placeholder="WORKING EXPERIENCE">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="input-group my-3">
                                                ...
                                                <input required type="number" value="5" class="form-control" name="NumberOfEmplyoee" placeholder="WORKING EXPERIENCE">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row my-3">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="n-chk">
                                                <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text">
                                                    <input type="checkbox" name="Gender[]" value="Male"  class="new-control-input">
                                    ...
                                    <div class="col-6">
                                        <div class="col-sm-12 col-md-4">
                                            <div class="n-chk">
                                                <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text">
                                                    <input type="checkbox" name="Gender[]" value="Female"  class="new-control-input">
                                ...
                                <div class="row my-3">
                                    <div class="col-6">
                                        <div class="n-chk">
                                            <label class="new-control new-radio radio-primary">
                                                <input type="radio" class="new-control-input" value="Need" name="DrivingLicense" >
                                    ...
                                    <div class="col-6">
                                        <div class="n-chk">
                                            <label class="new-control new-radio radio-primary">
                                                <input type="radio" class="new-control-input" value="NoNeed" name="DrivingLicense" checked>
...
<script>
    ...
    for (var q=0 ; q<Qualification.length; q++)
    {
        ...
        $(`.qualification-row`).append(`<div class="col-sm-12 col-md-4">
                            <div class="n-chk">
                                <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text">
                                    <input type="checkbox" name="qualification[]" value="${Qualification[q]}"  class="new-control-input">
