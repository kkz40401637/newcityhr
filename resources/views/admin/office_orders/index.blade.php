        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('AddStationNews')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> UPLOAD ORDER + </a>&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="table-responsive mb-4">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tbody>
                                    @foreach ($OfficeOrderDb as $key => $Post)
                                        <tr class="tr-{{$Post->id}}">
                                            <td><div class="td-content ">{{++$key}}</div></td>
                                            <td><div class="td-content text-dark">{{$Post->WarningUser->name}}</div></td>
                                            <td><div class="td-content text-dark">{{$Post->Title}}</div></td>
                                            <td><div class="td-content text-dark">{!!$Post->Description!!}</div></td>
                                            <td>
                                            ...
                                            <td>
                                                <button onclick="StationBanded({{$Post->id}})" class="station-ban-btn{{$Post->id}}  text-white btn bg-solid-red position-relative  ">
