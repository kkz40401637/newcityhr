                ...
                <div class="col-sm-12 col-md-8 layout-spacing ">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-5" data-form-permission="0" >
                            ...
                            <form action="{{route('EmployeeQualificationsSave')}}" class="form-sample" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="MaHar"  class="form-control" name="Degree" id="Degree" placeholder="DEGREE" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input  type="text" value="Myanmar"  class="form-control" name="Subject" id="Subject" value="{{ old('Subject') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="IT"  class="form-control" name="Institute" id="Institute" value="{{ old('Institute ') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="1990"  class="form-control" name="GraduationYear" id="GraduationYear" value="{{ old('GraduationYear ') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <p class="">FROM YEAR</p>
                                        <div class="input-group my-3">
                                            <input id="FromYear" name="FromYear" class="form-control flatpickr flatpickr-input active" type="text" placeholder="FROM YEAR..">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <p class="">TO YEAR</p>
                                        <div class="input-group my-3">
                                            <input id="ToYear" name="ToYear" class="form-control flatpickr flatpickr-input active" type="text" placeholder="TO YEAR..">
                                        </div>
                                    </div>
                                </div>
