                ...
                <div class="col-sm-12 col-md-8 layout-spacing ">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-5" data-form-permission="0" >
                            ...
                            <form action="{{route('EmployeeWorkExperiencesSave')}}" class="form-sample" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="APPLE"  class="form-control" name="OrganizationName" id="OrganizationName" placeholder="ORGANIZATIONNAME" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input  type="text" value="Myanmar"  class="form-control" name="JobDesignation" id="JobDesignation" value="{{ old('JobDesignation') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="IT"  class="form-control" name="JobField" id="JobField" value="{{ old('JobField ') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="JobStartDate" name="JobStartDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="JobStartDate..">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="JobEndDate" name="JobEndDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="JobEndDate..">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input  type="text" value="$400"  class="form-control" name="StartingSalary" id="StartingSalary" value="{{ old('StartingSalary') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="$1000"  class="form-control" name="EndingSalary" id="EndingSalary" value="{{ old('EndingSalary ') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input  type="text" value="COMPUTER"  class="form-control" name="TypeOfBusiness" id="TypeOfBusiness" value="{{ old('TypeOfBusiness') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="HAPPY TIME"  class="form-control" name="OtherBenefit" id="OtherBenefit" value="{{ old('OtherBenefit') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input  type="text" value="Travel"  class="form-control" name="ReasonForLeaving" id="ReasonForLeaving" value="{{ old('ReasonForLeaving') }}" placeholder="REASONFORLEAVING" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="HOLIDAYS"  class="form-control" name="Period" id="Period" value="{{ old('Period') }}" placeholder="Period" >
                                        </div>
                                    </div>
                                </div>

                                <p>JOBDESCRIPTION</p>
                                <textarea id="JobDescription" name="JobDescription" class="form-control JobDescription"  rows="10" cols="80">This is my textarea to be replaced with CKEditor 4.</textarea>
