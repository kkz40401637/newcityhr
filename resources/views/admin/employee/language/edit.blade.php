                ...
                <div class="col-sm-12 col-md-6 layout-spacing ">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-5" data-form-permission="0" >
                            ...
                            <form action="{{route('UpdateLanguage')}}" class="form-sample" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="LanguageToken" value="{{$LanguageDb->Token}}">
                                @if (session('success'))
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input  type="text" value="{{$LanguageDb->Language}}"  class="form-control" name="Language" id="Language" value="{{ old('Language') }}" placeholder="TrainingTitle" >
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            <select name="EmployeeID" class="form-control EmployeeID">
                                                <option>{{$LanguageDb->EmployeeID}}</option>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="{{$LanguageDb->SpeakingLevel}}"  class="form-control" name="SpeakingLevel" id="SpeakingLevel" value="{{ old('SpeakingLevel ') }}" placeholder="SPEAKINGLEVEL" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="{{$LanguageDb->ReadingLevel}}"  class="form-control" name="ReadingLevel" id="ReadingLevel" value="{{ old('ReadingLevel ') }}" placeholder="ReadingLevel" >
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input  type="text" value="{{$LanguageDb->WritingLevel}}"  class="form-control" name="WritingLevel" id="WritingLevel" value="{{ old('WritingLevel') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                </div>
