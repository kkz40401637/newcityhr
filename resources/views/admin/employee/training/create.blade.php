                ...
                <div class="col-sm-12 col-md-8 layout-spacing ">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-5" data-form-permission="0" >
                            ...
                            <form action="{{route('TrainingSave')}}" class="form-sample" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input  type="text" value="Myanmar"  class="form-control" name="TrainingTitle" id="TrainingTitle" value="{{ old('TrainingTitle') }}" placeholder="TrainingTitle" >
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-2">
                                            ...
                                            <input type="text" value="Aung Myo"  class="form-control" name="OrganizationName" id="OrganizationName" value="{{ old('OrganizationName ') }}" placeholder="RELIGION" >
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <p class="">LOCATION</p>
                                        <div class="input-group my-3">
                                            ...
                                            <input  type="text" value="Myanmar"  class="form-control" name="Location" id="Location" value="{{ old('Location') }}" placeholder="SUBJECT" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="TrainingStartDate" name="TrainingStartDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="TrainingStartDate..">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="TrainingEndDate" name="TrainingEndDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="TrainingEndDate..">
                                        </div>
                                    </div>
                                </div>
