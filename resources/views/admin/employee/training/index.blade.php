        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW TRAINING + </a>&nbsp;&nbsp;&nbsp;
                    <h3 class="d-inline float-right" >TRAINING lIST</h3>
                </div>
            </div>
            @if (session('success'))
                            ...
                            <div class="table-responsive mb-4">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><div class="th-content">STARTDATE</div></th>
                                        <th><div class="th-content">ENDDATE</div></th>
                                        <th><div class="th-content">Edit</div></th>
                                        <th><div class="th-content">Delete</div></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach ($TrainingDb as $key => $Training)
                                        <tr class="tr-{{$Training->id}}">
                                            ...
                                            <td><div class="td-content text-dark">
                                                    <span class="badge text-white badge-pills  bg-danger">
                                                        {{$Training->EmployeeID}}</span></div></td>
                                            <td><div class="td-content text-dark">{{$Training->JobField}}</div></td>
                                            <td><div class="td-content text-dark">{{$Training->TrainingTitle}}</div></td>
                                            <td><div class="td-content text-dark">{{$Training->OrganizationName}}</div></td>
                                            <td><div class="td-content text-dark">{{$Training->Location}}</div></td>
                                            <td><div class="td-content text-dark">{{$Training->TrainingStartDate}}</div></td>
                                            <td><div class="td-content text-dark">{{$Training->TrainingEndDate}}</div></td>
                                            <td>
                                                <a href="" class="td-content ">
                                                    <a class="btn btn-primary position-relative " href="{{route('EditTrainingInfo',$Training->Token)}}" >
                                                        <i class="material-icons ">edit</i>
                                                    </a>
                                                </a>
                                            </td>
                                            <td>
                                                <button onclick="StationBanded({{$Training->id}})" class="station-ban-btn{{$Training->id}}  text-white btn bg-solid-red position-relative  ">
