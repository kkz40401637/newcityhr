                ...
                <div class="col-sm-12 col-md-5 layout-spacing ">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-4" data-form-permission="0" >
                            ...
                            <form action="{{route('SsbFormSave')}}" class="form-sample" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="input-group my-2 ">
                                    ...
                                    <input  type="text" value=""  class="form-control" name="SsbNo" placeholder="SSB NO" >
                                </div>

                                <p class="">EMPLOYER NO</p>
                                <div class="input-group my-2 ">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">NO</span>
                                    </div>
                                    <input  type="text" value=""  class="form-control" name="EmployerNo" placeholder="EMPLOYER NO" >
                                </div>

                                <div class="form-group mb-4 mt-3">
                                    <label for="SsbFile">SSB FILE</label>
                                    <input type="file" name="FileUpload" class="form-control-file" id="SsbFile">
                                </div>
