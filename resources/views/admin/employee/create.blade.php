                    ...
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission p-5" data-form-permission="0" >
                            ...
                            <form id="employee-info-saving" enctype="multipart/form-data" class="form-sample" method="POST"  >
                                ...
                                <center><img src="{{asset('admin-assets/img/employee/original/employee.png')}}"
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input type="text" class="form-control" value="00001" autofocus="autofocus"  name="No" id="No " placeholder="EMPLOYEE NO." aria-label="notification" aria-describedby="basic-addon1">
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control" value="Aung Myo Htike"  name="Name" id="Name" placeholder="EMPLOYEE NAME" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <p class="my-2">USER</p>
                                        <div class="input-group my-3">
                                            <select name="UserId" class="form-control UserId" >
                                                @foreach($UserDb as $Index => $User)
                                                    <option value="{{$User->id}}" >{{$User->name .' ||   ( '.$User->UserRole->Name .' ) ' }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text"  class="form-control" value="အောင်မျိုးထိုက်" autofocus="autofocus"  name="NameMM" id="NameMM " placeholder="အမည်" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input  type="text" value="EMP00001" class="form-control"  name="CardId" id="CardId" placeholder="CARD ID" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="JoinDate" name="JoinDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Join Date..">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                        <input type="text" value="" class="form-control"  name="ResontoJoin" id="ResontoJoin" placeholder="RESON TO JOIN" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="099503843943" class="form-control"  name="PhoneNumber" id="PhoneNumber" placeholder="MOBILE PHONE NUMBER" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="aungmyohtike@infosoft.com" class="form-control"  name="OfficeEmail" id="OfficeEmail" placeholder="OFFICE EMAIL" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="ReportTo" id="ReportTo" placeholder="REPORT TO" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="0138748748" class="form-control"  name="OfficePhone" id="OfficePhone" placeholder="OFFICE PHONE NUMBER" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="DateOfBirth" name="DateOfBirth" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Join Date..">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <p class="my-2">Birth of Place</p>
                                        <div class="input-group my-3">
                                            <input id="BirthOfPlace" name="BirthOfPlace" class="form-control" type="text" placeholder="Birth of Place..">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="DateMarriage" name="DateMarriage" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Join Date..">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="city@gmail.com" class="form-control"  name="personalEmail" id="personalEmail" placeholder="PersonalEmail" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="8/PaKhaKa(N)112233" class="form-control"  name="NrcNumber" id="NrcNumber" placeholder="NRC Number " aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="၈/ပကန/(နိုင်)၁၁၂၂၃၃" class="form-control"  name="NrcNumberMM" id="NrcNumberMM" placeholder="Passport Number" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input type="text" value="1/2/2021" class="form-control Initial" name="PassportNumber" id="PassportNumber" placeholder="PassportNumber" aria-label="notification" aria-describedby="basic-addon1">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            <input id="PassportExpiration" name="PassportExpiration" class="form-control flatpickr flatpickr-input active" type="text" placeholder="PassportExpiration..">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <p class="my-2">Driving License Expiration</p>
                                        <div class="input-group my-3">
                                            <input id="DrivingLicenseExpiration" name="DrivingLicenseExpiration" class="form-control flatpickr flatpickr-input active" type="text" placeholder="DrivingLicenseExpiration..">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="DrivingLicenseNumber" id="DrivingLicenseNumber" placeholder="Driving License Number" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="StrongPoint" id="StrongPoint" placeholder="Strong Point" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="WeakPoint" id="WeakPoint" placeholder="Weak Point" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="FatalAccidentDescription" id="FatalAccidentDescription" placeholder="Fatal Accident Description" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="MajorSurgeryDescription " id="MajorSurgeryDescription " placeholder="Major Surgery Description" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="HospitalizationDescription" id="HospitalizationDescription" placeholder="Hospitalization Description" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="Yangon" class="form-control"  name="CurrentAddress" id="CurrentAddress" placeholder="Current Address" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="ရန်ကုန်" class="form-control"  name="CurrentAddressMM" id="CurrentAddressMM" placeholder="လက်ရှိလိပ်စာ" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="Myanmar" class="form-control"  name="PermanentAddress" id="PermanentAddress" placeholder="Current Address" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" value="မြန်မာနိုင်ငံ" class="form-control"  name="PermanentAddressMM" id="PermanentAddressMM" placeholder="အမြဲတမ်းလိပ်စာ" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group my-3">
                                            ...
                                            <input type="text" class="form-control"  name="DiscType" id="DiscType" placeholder="DISC Type" aria-label="notification" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <p class="my-2">DISC Test Date</p>
                                        <div class="input-group my-3">
                                            <input id="DiscTestDate" name="DiscTestDate" class="form-control flatpickr flatpickr-input active" type="text" placeholder="DiscTestDate..">
                                        </div>
                                    </div>
                                </div>
...
{{--                                <div class="input-group my-3">--}}
{{--                                    <textarea name="Information" id="Information" class="form-control" placeholder="Additional Information" >A paragraph is a ,</textarea>--}}
                                    <textarea id="Information" name="Information" class="form-control JobDescription"  rows="10" cols="80">This is my textarea to be replaced with CKEditor 4.</textarea>
{{--                                </div>--}}
