        ...
        <div class="layout-px-spacing data-out-put-div">
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('SaveRole')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW ROLE + </a>&nbsp;&nbsp;&nbsp;
                    <h3 class="d-inline float-right" >USER ROLE</h3>
                </div>
            </div>
            @if (session('message'))
...
{{--                                                </div>--}}
                                            ...
                                            <td>
                                                <button onclick="DepartmentBanded({{$Role->id}})" class="departmentId-ban-btn{{$Role->id}}  text-white btn bg-solid-red position-relative  ">
