                ...
                <div class="col-sm-12 col-md-4 layout-spacing">
                    <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                        ...
                        <div class="card-body form-permission " data-form-permission="0">
                            ...
                            <form action="{{route('AddRole')}}" class="form-sample" method="POST"  >
                                @csrf
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input type="text" autofocus="" required="required" min="4" class="form-control Title" name="Title" id="Title" placeholder="NAME" aria-label="notification" aria-describedby="basic-addon1">
                                </div>
                                <hr class="text-muted">
...
<script>
                                ...
                                <th>
                                   <div class="n-chk">
                                        <label class="new-control new-checkbox checkbox-primary">
                                            <input name="permissions[]" value="${SideBar[s]}" type="checkbox" class="new-control-input"  >
    ...
    // for (var s=0; s<SideBar.length; s++)
    // {
    //     $('.side-bar-permission').append(`<div class="n-chk">
    //                                     <label class="new-control new-checkbox checkbox-primary w-100 justify-content-between show-tick">
    //                                         <input name="permissions[]" value="${SideBar[s]}" type="checkbox" class="new-control-input"><br>
    //                                         <span class="new-control-indicator"></span>&nbsp;<b class="badge bg-danger">${SideBar[s]}</b>
    //                                     </label><br>
    //                                 </div>`);
    // }
