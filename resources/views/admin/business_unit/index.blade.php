        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('AddBusinessUnit')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW BUSINESS UNIT + </a>&nbsp;&nbsp;&nbsp;
                    <h3 class="d-inline float-right" >BUSINESS UNIT lIST</h3>
                </div>
            </div>
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="table-responsive mb-4">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tbody>
                                    @foreach ($BusinessUnit as $key => $BUnit)
                                        <tr class="tr-{{$BUnit->id}}">
                                            <td><div class="td-content ">{{++$key}}</div></td>
                                            <td>
                                                <img style="border-radius: 50%;" width="70px" height="70px;"
                                                     src="{{empty($BUnit->Profile)?asset('admin-assets/img/bu/original').'/bu-icon.png':asset('admin-assets/img/bu').'/'.$BUnit->Profile}}"></td>
                                            <td>
                                            ...
                                            <td><div class="td-content text-dark">{{$BUnit->Description}}</div></td>
                                            <td>
                                                <a class="btn btn-primary position-relative " href="{{route('EditCompanyInfo',$BUnit->Token)}}">
                                                    <i class="material-icons ">edit</i>
                                                </a>
                                            </td>
                                            <td>
                                                <button onclick="StationBanded({{$BUnit->id}})" class="station-ban-btn{{$BUnit->id}}  text-white btn bg-solid-red position-relative  ">
