        ...
        <div class="layout-px-spacing data-out-put-div">
            ...
            <div class="page-header">
                <div class="page-title">
                    <a href="{{route('AddStation')}}" class="d-inline btn btn-sm shadow-lg theme-bg theme-color "> ADD NEW BRANCH + </a>&nbsp;&nbsp;&nbsp;
                    <h3 class="d-inline float-right" >BRANCH lIST</h3>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-4">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><div class="th-content">BUSINESS UNITS</div></th>
                                        ...
                                        <tr class="tr-{{$station->id}}">
                                            ...
                                            <td>
                                                <div class="td-content text-dark">
                                                    ...
                                                    {{$station->StationName}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="td-content text-dark">
                                                    <span class="badge text-white badge-pills  bg-primary">
                                                    {{empty($station->BuID)?"":$station->BusinessUnitInfo->Name}}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="" class="td-content ">
                                                    <a class="btn btn-primary position-relative " href="{{route('EditStation',$station->Token)}}" >
