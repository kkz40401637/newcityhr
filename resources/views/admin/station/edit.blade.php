...
<link href="{{asset('admin-assets/plugins/bootstrap-range-Slider/bootstrap-slider.css')}}" rel="stylesheet"
      type="text/css">
                    ...
                    <div class="col-sm-12 col-md-7   layout-spacing">
                        <div class="card shadow-lg animated slideInLeft" style="border-radius: 13px 13px 0 0">
                            ...
                            <div class="card-body form-permission " data-form-permission="0">
                                ...
                                <form id="station-info-saving" method="POST" enctype="multipart/form-data"
                                      class="form-sample"  >
                                    <input type="hidden" name="StationToken" value="{{$Station->Token}}">
                                    <p>Click To Chose Branch Photo</p>
                                    <center>

                                        <img
                                            src="{{empty($Station->images) ? asset('admin-assets/img/station/station.jpg') : asset('admin-assets/img/station').'/'.$Station->images}}"
                                            {{--                                            src="{{asset('admin-assets/img/station').'/'.$Station->images}}"--}}

                                            style="height: 150px; width: 150px; " id="DisplayImageTag" alt="">
                                    </center>

                                    <input class="btn btn-dark p-0 m-0" type="file" name="images" id="FileInputVal"
                                           style="visibility: hidden;"/>
                                    <input class="btn btn-dark p-0 m-0" type="hidden" class="FileChange" id="FileChange"
                                           name="FileChange" value="0">
                                    ...
                                    <div class="input-group form-row mb-6">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                ...
                                                <input autofocus="" id="StationName" type="text" class="form-control"
                                                       name="StationName" value="{{ $Station->StationName }}" required
                                                       autocomplete="StationName" placeholder="StationName" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <span class="input-group-text">
                                                ...
                                                <input type="number" class="form-control" autofocus="autofocus"
                                                       ...
                                                       value="{{ $Station->PhoneNumber }}" placeholder="Phone Number"
                                    ...
                                    <div class="form-row mb-6">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                <select id="BuID" name="BuID" class="form-control">
                                                    @foreach($BusinessUnitDb as $Bu)
                                                        <option {{$Station->BuID==$Bu->id?"selected":''}} value="{{$Bu->id}}">{{$Bu->Name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                ...
                                                <input type="number " class="form-control" autofocus="autofocus"
                                                       id="FaxNumber" name="FaxNumber" value="{{ $Station->FaxNumber }}"
                                                       placeholder="Fax Number" aria-label="notification"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <span class="input-group-text">
                                                ...
                                                <input type="text" class="form-control" autofocus="autofocus"
                                                       id="CurrencyUse" name="CurrencyUse"
                                                       value="{{ $Station->CurrencyUse }}" placeholder="US dollar"
                                                       aria-label="notification" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                ...
                                                <input type="text" class="form-control" autofocus="autofocus"
                                                       id="CurrencySymbol" name="CurrencySymbol"
                                                       placeholder="Currency Symbol" aria-label="notification"
                                                       value="{{$Station->CurrencySymbol}}"
                                    ...
                                    <div class="form-row mb-6">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                ...
                                                <input type="text" class="form-control" autofocus="autofocus"
                                                       id="WebSite" name="WebSite" value="{{ $Station->WebSite }}"
                                                       placeholder="http://" aria-label="notification"
                                                       aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-2 col">
                                                ...
                                                <input type="text" class="form-control" autofocus="autofocus"
                                                       ...
                                                       value="{{ $Station->EmailAddress }}" placeholder="Email Address"
                                                       aria-label="notification" aria-describedby="basic-addon1"
                                                       required>
                                            </div>
                                        </div>
                                    ...
                                    <textarea class="form-control" name="AdditionalNote" id="demo1">
                                        {!! $Station->AdditionalNote !!}
                                    </textarea>
                                        ...
                                        <button type="submit"
                                                class="btn save-station-info-btn theme-bg theme-color mt-2 col-12">SAVE
                                        </button>
                                        <br>
