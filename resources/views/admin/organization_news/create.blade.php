                        ...
                        <div class="card-body form-permission " data-form-permission="0">
                            ...
                            <form id="station-news-form" class="form-sample"  enctype="multipart/form-data" >
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input type="text" class="form-control Title" value="🎉🍾 Our company has 45%  benefited 🍾🎉" placeholder="NEWS TITLE"  aria-label="notification" aria-describedby="basic-addon1">
                                </div>

                                <div class="input-group mt-3 " >
                                    <b class="StationError d-none text-danger">CHOICE BRANCH ....</b>
                                    <select class="form-control StationID" name="StationID[]" style="border: 1px solid red !important;"  multiple="multiple" >
                                ...
                                <div class="input-group mb-2 " >
                                    <textarea name="NewsDescription" class="form-control NewsDescription"  rows="10" cols="80">
...
<script>
     ...
     let OrganizationNews = '{{route('OrganizationNewsList')}}';
                     ...
                     $.post("{{route('OrganizationNews')}}",
                         ...
                         function(data){
                             ...
                             if (data.code == 200)
                             {
                                 ...
                                 setTimeout(function(){ window.location.href = OrganizationNews; }, 2000);
                             }
